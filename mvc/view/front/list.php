<?php
//                foreach (DBManagerObject::getAll() as $object){
...
//                                    echo '<h4 class="col-6 text-break text-uppercase">'.$object->getName().'</h4>';
...
//                }
//                ?>
<!--<script type="text/javascript" src="view/front/front-scripts/generateItemsFromSession.js"></script>-->
