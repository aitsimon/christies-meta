<section class="container d-flex justify-content-end">
    <a href="./../../../mvc/index.php/admin/dashboard/users/add" class="my-3"><button type="button" class="btn btn-success"><span class="mr-3">Add a new User</span><i class="fas fa-plus-circle"></i></button></a>
</section>
